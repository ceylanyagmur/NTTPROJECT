        ...
        endAdornment={
          <CustomSelect
            ...
            renderValue={(selected) => {
              if (!selectBoxValue) {
                return <span>Kategoriler</span>;
              }

              return selected;
            }}
          >
            <MenuItem value={'Data'}>Veri</MenuItem>
            <MenuItem value={'Category Name'}>Kategori Adı</MenuItem>
            <MenuItem value={'Category Name'}>Kategori Sınıfları</MenuItem>
          </CustomSelect>
        }
        size="medium"
      />
